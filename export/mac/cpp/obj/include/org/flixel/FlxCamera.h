...
class FlxCamera_obj : public ::org::flixel::FlxBasic_obj{
	...
	public:
		...
		virtual Void follow( ::org::flixel::FlxObject Target,hx::Null< int >  Style,::org::flixel::FlxPoint Offset,hx::Null< Float >  Lerp);
		Dynamic follow_dyn();
		...
		Float green; /* REM */ 
		Float red; /* REM */ 
		::native::display::Sprite _effectsLayer; /* REM */ 
		...
		::org::flixel::FlxPoint _scrollTarget; /* REM */ 
		::org::flixel::FlxPoint _lastTargetPosition; /* REM */ 
		...
		Float followLerp; /* REM */ 
		::native::geom::Point followLead; /* REM */ 
