...
class FlxG_obj : public hx::Object{
	...
	public:
		...
		static ::org::flixel::FlxTypedGroup sounds; /* REM */ 
		...
		static ::org::flixel::system::input::FlxMouse mouse; /* REM */ 
		static ::org::flixel::system::input::FlxKeyboard keys; /* REM */ 
		static ::org::flixel::system::input::FlxTouchManager touchManager; /* REM */ 
		static ::org::flixel::system::input::FlxJoystickManager joystickManager; /* REM */ 
