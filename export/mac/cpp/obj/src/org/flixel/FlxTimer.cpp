...
Float FlxTimer_obj::get_progress( ){
	HX_STACK_PUSH("FlxTimer::get_progress","org/flixel/FlxTimer.hx",167);
	HX_STACK_THIS(this);
	HX_STACK_LINE(167)
	if (((this->time > (int)0))){
		HX_STACK_LINE(169)
...
int FlxTimer_obj::get_loopsLeft( ){
	HX_STACK_PUSH("FlxTimer::get_loopsLeft","org/flixel/FlxTimer.hx",157);
	HX_STACK_THIS(this);
	HX_STACK_LINE(157)
...
Float FlxTimer_obj::get_timeLeft( ){
	HX_STACK_PUSH("FlxTimer::get_timeLeft","org/flixel/FlxTimer.hx",147);
	HX_STACK_THIS(this);
	HX_STACK_LINE(147)
...
::org::flixel::plugin::TimerManager FlxTimer_obj::get_manager( ){
	HX_STACK_PUSH("FlxTimer::get_manager","org/flixel/FlxTimer.hx",181);
	HX_STACK_LINE(181)
