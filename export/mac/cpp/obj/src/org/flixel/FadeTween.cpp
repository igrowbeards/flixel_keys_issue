...
{
HX_STACK_PUSH("FadeTween::new","org/flixel/FlxSound.hx",602);
{
	HX_STACK_LINE(603)
...
Float FadeTween_obj::get_value( ){
	HX_STACK_PUSH("FadeTween::get_value","org/flixel/FlxSound.hx",671);
	HX_STACK_THIS(this);
	HX_STACK_LINE(671)
...
bool FadeTween_obj::get_finished( ){
	HX_STACK_PUSH("FadeTween::get_finished","org/flixel/FlxSound.hx",664);
	HX_STACK_THIS(this);
	HX_STACK_LINE(664)
...
Float FadeTween_obj::set_progress( Float value){
	HX_STACK_PUSH("FadeTween::set_progress","org/flixel/FlxSound.hx",647);
	HX_STACK_THIS(this);
...
Float FadeTween_obj::get_progress( ){
	HX_STACK_PUSH("FadeTween::get_progress","org/flixel/FlxSound.hx",642);
	HX_STACK_THIS(this);
	HX_STACK_LINE(642)
	return this->_progress;
}
...
{
		HX_STACK_PUSH("FadeTween::destroy","org/flixel/FlxSound.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(614)
...
Float FadeTween_obj::linear( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("FadeTween::linear","org/flixel/FlxSound.hx",686);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
	HX_STACK_ARG(d,"d");
...
Dynamic FadeTween_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"progress") ) { if (inCallProp) return set_progress(inValue);progress=inValue.Cast< Float >(); return inValue; }
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.FadeTween"), hx::TCanCast< FadeTween_obj> ,sStaticFields,sMemberFields,
