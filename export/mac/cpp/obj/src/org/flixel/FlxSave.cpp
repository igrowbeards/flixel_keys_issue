		...
		if (((bool((::org::flixel::FlxG_obj::_game != null())) && bool((::org::flixel::FlxG_obj::_game->getDebugger() != null()))))){
			struct _Function_3_1{
				inline static ::String Block( ){
					HX_STACK_PUSH("*::closure","org/flixel/FlxSave.hx",211);
					{
						HX_STACK_LINE(211)
						Dynamic AnyArray = hx::TCastToArray(HX_CSTRING("FLIXEL: You must call FlxSave.bind()\nbefore you can read or write data."));		HX_STACK_VAR(AnyArray,"AnyArray");
						HX_STACK_LINE(211)
			...
			HX_STACK_LINE(211)
			::org::flixel::FlxG_obj::_game->getDebugger()->log->add((  ((::Std_obj::is(HX_CSTRING("FLIXEL: You must call FlxSave.bind()\nbefore you can read or write data."),hx::ClassOf< Array<int> >()))) ? ::String(_Function_3_1::Block()) : ::String(::Std_obj::string(HX_CSTRING("FLIXEL: You must call FlxSave.bind()\nbefore you can read or write data."))) ));
		}
		HX_STACK_LINE(212)
		return false;
	}
...
bool FlxSave_obj::onDone( int Result){
	...
	if (  ( _switch_1==::org::flixel::FlxSave_obj::PENDING)){
		...
		if (((bool((::org::flixel::FlxG_obj::_game != null())) && bool((::org::flixel::FlxG_obj::_game->getDebugger() != null()))))){
			struct _Function_3_1{
				inline static ::String Block( ){
					HX_STACK_PUSH("*::closure","org/flixel/FlxSave.hx",187);
					{
						HX_STACK_LINE(187)
						Dynamic AnyArray = hx::TCastToArray(HX_CSTRING("FLIXEL: FlxSave is requesting extra storage space."));		HX_STACK_VAR(AnyArray,"AnyArray");
						HX_STACK_LINE(187)
						::String string = HX_CSTRING("");		HX_STACK_VAR(string,"string");
						HX_STACK_LINE(187)
						if (((bool((AnyArray != null())) && bool((AnyArray->__Field(HX_CSTRING("length"),true) > (int)0))))){
			...
			HX_STACK_LINE(187)
			::org::flixel::FlxG_obj::_game->getDebugger()->log->add((  ((::Std_obj::is(HX_CSTRING("FLIXEL: FlxSave is requesting extra storage space."),hx::ClassOf< Array<int> >()))) ? ::String(_Function_3_1::Block()) : ::String(::Std_obj::string(HX_CSTRING("FLIXEL: FlxSave is requesting extra storage space."))) ));
		}
	}
		...
		if (((bool((::org::flixel::FlxG_obj::_game != null())) && bool((::org::flixel::FlxG_obj::_game->getDebugger() != null()))))){
			struct _Function_3_1{
				inline static ::String Block( ){
					HX_STACK_PUSH("*::closure","org/flixel/FlxSave.hx",189);
					{
						HX_STACK_LINE(189)
						Dynamic AnyArray = hx::TCastToArray(HX_CSTRING("ERROR: There was a problem flushing\nthe shared object data from FlxSave."));		HX_STACK_VAR(AnyArray,"AnyArray");
						HX_STACK_LINE(189)
						::String string = HX_CSTRING("");		HX_STACK_VAR(string,"string");
						HX_STACK_LINE(189)
						if (((bool((AnyArray != null())) && bool((AnyArray->__Field(HX_CSTRING("length"),true) > (int)0))))){
			...
			HX_STACK_LINE(189)
			::org::flixel::FlxG_obj::_game->getDebugger()->log->add((  ((::Std_obj::is(HX_CSTRING("ERROR: There was a problem flushing\nthe shared object data from FlxSave."),hx::ClassOf< Array<int> >()))) ? ::String(_Function_3_1::Block()) : ::String(::Std_obj::string(HX_CSTRING("ERROR: There was a problem flushing\nthe shared object data from FlxSave."))) ));
		}
	}
	HX_STACK_LINE(192)
		...
		if (__e.IsClass< ::native::errors::Error >() ){
			::native::errors::Error e = __e;{
				...
				if (((bool((::org::flixel::FlxG_obj::_game != null())) && bool((::org::flixel::FlxG_obj::_game->getDebugger() != null()))))){
					struct _Function_3_1{
						inline static ::String Block( ){
							HX_STACK_PUSH("*::closure","org/flixel/FlxSave.hx",82);
							{
								HX_STACK_LINE(82)
								Dynamic AnyArray = hx::TCastToArray(HX_CSTRING("ERROR: There was a problem binding to\nthe shared object data from FlxSave."));		HX_STACK_VAR(AnyArray,"AnyArray");
								HX_STACK_LINE(82)
								::String string = HX_CSTRING("");		HX_STACK_VAR(string,"string");
								HX_STACK_LINE(82)
								if (((bool((AnyArray != null())) && bool((AnyArray->__Field(HX_CSTRING("length"),true) > (int)0))))){
					...
					HX_STACK_LINE(82)
					::org::flixel::FlxG_obj::_game->getDebugger()->log->add((  ((::Std_obj::is(HX_CSTRING("ERROR: There was a problem binding to\nthe shared object data from FlxSave."),hx::ClassOf< Array<int> >()))) ? ::String(_Function_3_1::Block()) : ::String(::Std_obj::string(HX_CSTRING("ERROR: There was a problem binding to\nthe shared object data from FlxSave."))) ));
				}
				HX_STACK_LINE(83)
				this->destroy();
				HX_STACK_LINE(84)
