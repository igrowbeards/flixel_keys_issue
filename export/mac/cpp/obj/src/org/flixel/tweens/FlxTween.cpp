...
Dynamic FlxTween_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"percent") ) { return inCallProp ? get_percent() : percent; }
...
Dynamic FlxTween_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"percent") ) { if (inCallProp) return set_percent(inValue);percent=inValue.Cast< Float >(); return inValue; }
		break;
	case 8:
