...
int PxBitmapFont_obj::get_numLetters( ){
	HX_STACK_PUSH("PxBitmapFont::get_numLetters","org/flixel/plugin/pxText/PxBitmapFont.hx",731);
	HX_STACK_THIS(this);
	HX_STACK_LINE(731)
...
::String PxBitmapFont_obj::get_bitmapDataKey( ){
	HX_STACK_PUSH("PxBitmapFont::get_bitmapDataKey","org/flixel/plugin/pxText/PxBitmapFont.hx",725);
	HX_STACK_THIS(this);
	HX_STACK_LINE(725)
...
::native::display::BitmapData PxBitmapFont_obj::get_pixels( ){
	HX_STACK_PUSH("PxBitmapFont::get_pixels","org/flixel/plugin/pxText/PxBitmapFont.hx",718);
	HX_STACK_THIS(this);
	HX_STACK_LINE(718)
	return this->_pixels;
}
...
int PxBitmapFont_obj::bgTileID( ::String AtlasName){
	HX_STACK_PUSH("PxBitmapFont::bgTileID","org/flixel/plugin/pxText/PxBitmapFont.hx",711);
	HX_STACK_THIS(this);
...
int PxBitmapFont_obj::getFontHeight( ){
	HX_STACK_PUSH("PxBitmapFont::getFontHeight","org/flixel/plugin/pxText/PxBitmapFont.hx",699);
	HX_STACK_THIS(this);
	HX_STACK_LINE(699)
...
Float pFontScale = __o_pFontScale.Default(1.0);
	HX_STACK_PUSH("PxBitmapFont::getTextWidth","org/flixel/plugin/pxText/PxBitmapFont.hx",661);
	HX_STACK_THIS(this);
...
bool pUseColor = __o_pUseColor.Default(true);
	HX_STACK_PUSH("PxBitmapFont::render","org/flixel/plugin/pxText/PxBitmapFont.hx",581);
	HX_STACK_THIS(this);
	HX_STACK_ARG(atlasName,"atlasName");
...
int pAdvanceX = __o_pAdvanceX.Default(0);
	HX_STACK_PUSH("PxBitmapFont::setGlyph","org/flixel/plugin/pxText/PxBitmapFont.hx",549);
	HX_STACK_THIS(this);
...
bool total = __o_total.Default(true);
	HX_STACK_PUSH("PxBitmapFont::dispose","org/flixel/plugin/pxText/PxBitmapFont.hx",477);
	HX_STACK_THIS(this);
...
::native::display::BitmapData PxBitmapFont_obj::prepareAngelCodeBitmapData( ::native::display::BitmapData pBitmapData,::Xml pXMLData,Array< ::org::flixel::plugin::pxText::HelperSymbol > pSymbols){
	HX_STACK_PUSH("PxBitmapFont::prepareAngelCodeBitmapData","org/flixel/plugin/pxText/PxBitmapFont.hx",357);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("PxBitmapFont::store","org/flixel/plugin/pxText/PxBitmapFont.hx",745);
...
::org::flixel::plugin::pxText::PxBitmapFont PxBitmapFont_obj::fetch( ::String pHandle){
	HX_STACK_PUSH("PxBitmapFont::fetch","org/flixel/plugin/pxText/PxBitmapFont.hx",755);
	HX_STACK_ARG(pHandle,"pHandle");
	HX_STACK_LINE(756)
...
{
		HX_STACK_PUSH("PxBitmapFont::clearStorage","org/flixel/plugin/pxText/PxBitmapFont.hx",761);
		HX_STACK_LINE(762)
