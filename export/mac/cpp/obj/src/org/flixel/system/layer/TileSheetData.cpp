...
HX_STACK_PUSH("TileSheetData::new","org/flixel/system/layer/TileSheetData.hx",106);
{
	...
	HX_STACK_LINE(109)
	this->flxSpriteFrames = ::Hash_obj::__new();
}
;
	return null();
}
...
{
		HX_STACK_PUSH("TileSheetData::destroy","org/flixel/system/layer/TileSheetData.hx",255);
		HX_STACK_THIS(this);
		HX_STACK_LINE(256)
		...
		this->pairsData = null();
		HX_STACK_LINE(265)
		for(::cpp::FastIterator_obj< ::org::flixel::system::layer::FlxSpriteFrames > *__it = ::cpp::CreateFastIterator< ::org::flixel::system::layer::FlxSpriteFrames >(this->flxSpriteFrames->iterator());  __it->hasNext(); ){
			::org::flixel::system::layer::FlxSpriteFrames spriteData = __it->next();
			spriteData->destroy();
		}
		HX_STACK_LINE(269)
...
int TileSheetData_obj::getTileRectID( ::native::geom::Rectangle rect,::native::geom::Point point){
	HX_STACK_PUSH("TileSheetData::getTileRectID","org/flixel/system/layer/TileSheetData.hx",233);
	HX_STACK_THIS(this);
...
bool TileSheetData_obj::containsTileRect( ::native::geom::Rectangle rect,::native::geom::Point point){
	HX_STACK_PUSH("TileSheetData::containsTileRect","org/flixel/system/layer/TileSheetData.hx",210);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_ARG(point,"point");
	HX_STACK_LINE(211)
...
int TileSheetData_obj::addTileRect( ::native::geom::Rectangle rect,::native::geom::Point point){
	HX_STACK_PUSH("TileSheetData::addTileRect","org/flixel/system/layer/TileSheetData.hx",195);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_ARG(point,"point");
	HX_STACK_LINE(196)
...
::String TileSheetData_obj::getKeyforSpriteFrameData( int width,int height,int startX,int startY,int endX,int endY,int xSpacing,int ySpacing,Float pointX,Float pointY){
	HX_STACK_PUSH("TileSheetData::getKeyforSpriteFrameData","org/flixel/system/layer/TileSheetData.hx",186);
	HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC10(TileSheetData_obj,getKeyforSpriteFrameData,return )
...
bool TileSheetData_obj::containsSpriteFrameData( int width,int height,int startX,int startY,int endX,int endY,int xSpacing,int ySpacing,Float pointX,Float pointY){
	...
	HX_STACK_ARG(pointY,"pointY");
	HX_STACK_LINE(181)
	::String key = this->getKeyforSpriteFrameData(width,height,startX,startY,endX,endY,xSpacing,ySpacing,pointX,pointY);		HX_STACK_VAR(key,"key");
	HX_STACK_LINE(182)
	...
	HX_STACK_ARG(ySpacing,"ySpacing");
{
		...
		HX_STACK_LINE(174)
		spriteData->halfFrameNumber = ::Std_obj::_int((0.5 * spriteData->frameIDs->length));
		HX_STACK_LINE(175)
...
Dynamic TileSheetData_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 23:
		...
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"getKeyforSpriteFrameData") ) { return getKeyforSpriteFrameData_dyn(); }
	}
...
Dynamic TileSheetData_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 13:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"flxSpriteFrames") ) { flxSpriteFrames=inValue.Cast< ::Hash >(); return inValue; }
	}
...
static ::String sMemberFields[] = {
	...
	HX_CSTRING("getKeyforSpriteFrameData"),
