...
bool FlxQuadTree_obj::overlapNode( ){
	HX_STACK_PUSH("FlxQuadTree::overlapNode","org/flixel/system/FlxQuadTree.hx",644);
	HX_STACK_THIS(this);
	HX_STACK_LINE(646)
...
bool FlxQuadTree_obj::execute( ){
	HX_STACK_PUSH("FlxQuadTree::execute","org/flixel/system/FlxQuadTree.hx",590);
	HX_STACK_THIS(this);
	HX_STACK_LINE(591)
	bool overlapProcessed = false;		HX_STACK_VAR(overlapProcessed,"overlapProcessed");
	HX_STACK_LINE(592)
...
{
		HX_STACK_PUSH("FlxQuadTree::addToList","org/flixel/system/FlxQuadTree.hx",540);
		HX_STACK_THIS(this);
		HX_STACK_LINE(541)
...
{
		HX_STACK_PUSH("FlxQuadTree::addObject","org/flixel/system/FlxQuadTree.hx",449);
		HX_STACK_THIS(this);
		HX_STACK_LINE(451)
...
{
		HX_STACK_PUSH("FlxQuadTree::add","org/flixel/system/FlxQuadTree.hx",397);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("FlxQuadTree::load","org/flixel/system/FlxQuadTree.hx",374);
		HX_STACK_THIS(this);
