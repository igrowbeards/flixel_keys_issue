...
{
HX_STACK_PUSH("FlxJoyButton::new","org/flixel/system/input/FlxJoystick.hx",208);
...
{
		HX_STACK_PUSH("FlxJoyButton::reset","org/flixel/system/input/FlxJoystick.hx",215);
		HX_STACK_THIS(this);
		HX_STACK_LINE(216)
		this->current = (int)0;
		HX_STACK_LINE(217)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.input.FlxJoyButton"), hx::TCanCast< FlxJoyButton_obj> ,sStaticFields,sMemberFields,
