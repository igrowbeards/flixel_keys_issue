...
{
HX_STACK_PUSH("FlxTouch::new","org/flixel/system/input/FlxTouch.hx",54);
...
bool FlxTouch_obj::isActive( ){
	HX_STACK_PUSH("FlxTouch::isActive","org/flixel/system/input/FlxTouch.hx",218);
	HX_STACK_THIS(this);
	HX_STACK_LINE(218)
...
bool FlxTouch_obj::justReleased( ){
	HX_STACK_PUSH("FlxTouch::justReleased","org/flixel/system/input/FlxTouch.hx",212);
	HX_STACK_THIS(this);
	HX_STACK_LINE(212)
...
bool FlxTouch_obj::justPressed( ){
	HX_STACK_PUSH("FlxTouch::justPressed","org/flixel/system/input/FlxTouch.hx",206);
	HX_STACK_THIS(this);
	HX_STACK_LINE(206)
...
bool FlxTouch_obj::pressed( ){
	HX_STACK_PUSH("FlxTouch::pressed","org/flixel/system/input/FlxTouch.hx",200);
	HX_STACK_THIS(this);
	HX_STACK_LINE(200)
	return (this->_current > (int)0);
}
...
{
		HX_STACK_PUSH("FlxTouch::deactivate","org/flixel/system/input/FlxTouch.hx",191);
		HX_STACK_THIS(this);
		HX_STACK_LINE(192)
		this->_current = (int)0;
		HX_STACK_LINE(193)
...
{
		HX_STACK_PUSH("FlxTouch::reset","org/flixel/system/input/FlxTouch.hx",183);
		HX_STACK_THIS(this);
		HX_STACK_ARG(X,"X");
		HX_STACK_ARG(Y,"Y");
...
::org::flixel::FlxPoint FlxTouch_obj::getScreenPosition( ::org::flixel::FlxCamera Camera,::org::flixel::FlxPoint point){
	HX_STACK_PUSH("FlxTouch::getScreenPosition","org/flixel/system/input/FlxTouch.hx",165);
	HX_STACK_THIS(this);
...
::org::flixel::FlxPoint FlxTouch_obj::getWorldPosition( ::org::flixel::FlxCamera Camera,::org::flixel::FlxPoint point){
	HX_STACK_PUSH("FlxTouch::getWorldPosition","org/flixel/system/input/FlxTouch.hx",142);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Camera,"Camera");
	HX_STACK_ARG(point,"point");
	HX_STACK_LINE(143)
...
{
		HX_STACK_PUSH("FlxTouch::updateCursor","org/flixel/system/input/FlxTouch.hx",124);
		HX_STACK_THIS(this);
		HX_STACK_LINE(127)
...
{
		HX_STACK_PUSH("FlxTouch::updateTouchPosition","org/flixel/system/input/FlxTouch.hx",110);
		HX_STACK_THIS(this);
		HX_STACK_ARG(X,"X");
		HX_STACK_ARG(Y,"Y");
		HX_STACK_LINE(111)
...
{
		HX_STACK_PUSH("FlxTouch::update","org/flixel/system/input/FlxTouch.hx",92);
		HX_STACK_THIS(this);
		HX_STACK_LINE(93)
...
int FlxTouch_obj::get_touchPointID( ){
	HX_STACK_PUSH("FlxTouch::get_touchPointID","org/flixel/system/input/FlxTouch.hx",84);
	HX_STACK_THIS(this);
	HX_STACK_LINE(84)
...
{
		HX_STACK_PUSH("FlxTouch::destroy","org/flixel/system/input/FlxTouch.hx",72);
		HX_STACK_THIS(this);
		HX_STACK_LINE(73)
		this->_point = null();
		HX_STACK_LINE(74)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.input.FlxTouch"), hx::TCanCast< FlxTouch_obj> ,sStaticFields,sMemberFields,
