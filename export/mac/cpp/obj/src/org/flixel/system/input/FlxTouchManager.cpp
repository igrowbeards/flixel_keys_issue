...
{
	HX_STACK_LINE(44)
	this->touches = Array_obj< ::org::flixel::system::input::FlxTouch >::__new();
	HX_STACK_LINE(45)
	this->_inactiveTouches = Array_obj< ::org::flixel::system::input::FlxTouch >::__new();
	HX_STACK_LINE(46)
	this->_touchesCache = ::IntHash_obj::__new();
	HX_STACK_LINE(47)
	::org::flixel::system::input::FlxTouchManager_obj::maxTouchPoints = ::native::ui::Multitouch_obj::maxTouchPoints;
	HX_STACK_LINE(48)
	...
	HX_STACK_LINE(51)
	::nme::Lib_obj::get_current()->get_stage()->addEventListener(::native::events::TouchEvent_obj::TOUCH_BEGIN,this->handleTouchBegin_dyn(),null(),null(),null());
	HX_STACK_LINE(52)
	::nme::Lib_obj::get_current()->get_stage()->addEventListener(::native::events::TouchEvent_obj::TOUCH_END,this->handleTouchEnd_dyn(),null(),null(),null());
	HX_STACK_LINE(53)
	::nme::Lib_obj::get_current()->get_stage()->addEventListener(::native::events::TouchEvent_obj::TOUCH_MOVE,this->handleTouchMove_dyn(),null(),null(),null());
}
;
	return null();
}
...
hx::Object *FlxTouchManager_obj::__ToInterface(const type_info &inType) {
...
::org::flixel::system::input::FlxTouch FlxTouchManager_obj::recycle( Float X,Float Y,int PointID){
	...
	if (((this->_inactiveTouches->length > (int)0))){
		HX_STACK_LINE(274)
		::org::flixel::system::input::FlxTouch touch = this->_inactiveTouches->pop();		HX_STACK_VAR(touch,"touch");
		HX_STACK_LINE(275)
...
Array< ::org::flixel::system::input::FlxTouch > FlxTouchManager_obj::justReleasedTouches( Array< ::org::flixel::system::input::FlxTouch > TouchArray){
	...
	if (((TouchArray == null()))){
		HX_STACK_LINE(230)
		TouchArray = Array_obj< ::org::flixel::system::input::FlxTouch >::__new();
	}
	HX_STACK_LINE(234)
	...
	HX_STACK_LINE(240)
	{
		...
		Array< ::org::flixel::system::input::FlxTouch > _g1 = this->touches;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(240)
		while(((_g < _g1->length))){
			HX_STACK_LINE(240)
			::org::flixel::system::input::FlxTouch touch = _g1->__get(_g);		HX_STACK_VAR(touch,"touch");
			HX_STACK_LINE(240)
			++(_g);
			HX_STACK_LINE(242)
...
Array< ::org::flixel::system::input::FlxTouch > FlxTouchManager_obj::justStartedTouches( Array< ::org::flixel::system::input::FlxTouch > TouchArray){
...
Void FlxTouchManager_obj::handleTouchMove( ::native::events::TouchEvent FlashEvent){
{
...
Void FlxTouchManager_obj::handleTouchEnd( ::native::events::TouchEvent FlashEvent){
{
...
Void FlxTouchManager_obj::handleTouchBegin( ::native::events::TouchEvent FlashEvent){
{
...
Void FlxTouchManager_obj::destroy( ){
{
		...
		HX_STACK_LINE(78)
		{
			HX_STACK_LINE(78)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			Array< ::org::flixel::system::input::FlxTouch > _g1 = this->_inactiveTouches;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(78)
			while(((_g < _g1->length))){
				HX_STACK_LINE(78)
				::org::flixel::system::input::FlxTouch touch = _g1->__get(_g);		HX_STACK_VAR(touch,"touch");
...
::org::flixel::system::input::FlxTouch FlxTouchManager_obj::getFirstTouch( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(60)
	if (((this->touches->__get((int)0) != null()))){
		HX_STACK_LINE(62)
		return this->touches->__get((int)0);
	}
	else{
		HX_STACK_LINE(64)
		return null();
...
Dynamic FlxTouchManager_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"touches") ) { touches=inValue.Cast< Array< ::org::flixel::system::input::FlxTouch > >(); return inValue; }
		break;
	case 13:
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"_inactiveTouches") ) { _inactiveTouches=inValue.Cast< Array< ::org::flixel::system::input::FlxTouch > >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.input.FlxTouchManager"), hx::TCanCast< FlxTouchManager_obj> ,sStaticFields,sMemberFields,
