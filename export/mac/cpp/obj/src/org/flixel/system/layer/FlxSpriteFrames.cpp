...
{
HX_STACK_PUSH("FlxSpriteFrames::new","org/flixel/system/layer/TileSheetData.hx",292);
{
	HX_STACK_LINE(293)
	this->width = width;
	HX_STACK_LINE(294)
...
{
		HX_STACK_PUSH("FlxSpriteFrames::destroy","org/flixel/system/layer/TileSheetData.hx",311);
		HX_STACK_THIS(this);
		HX_STACK_LINE(311)
		this->frameIDs = null();
	}
