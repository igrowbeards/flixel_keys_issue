...
Array< ::org::flixel::system::input::IFlxInput > FlxInputs_obj::inputs;
...
Void FlxInputs_obj::init( ){
{
		...
		HX_STACK_LINE(24)
		::org::flixel::system::input::FlxInputs_obj::inputs = Array_obj< ::org::flixel::system::input::IFlxInput >::__new();
		HX_STACK_LINE(27)
...
::org::flixel::system::input::IFlxInput FlxInputs_obj::addInput( ::org::flixel::system::input::IFlxInput input){
	...
	HX_STACK_LINE(51)
	{
		...
		while(((_g < l))){
			...
			HX_STACK_LINE(53)
			if (((::org::flixel::system::input::FlxInputs_obj::inputs->__get(i)->toString() == ::org::flixel::system::input::FlxInputs_obj::inputs->toString()))){
				HX_STACK_LINE(54)
				return input;
			}
		}
...
Dynamic FlxInputs_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"inputs") ) { inputs=inValue.Cast< Array< ::org::flixel::system::input::IFlxInput > >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.input.FlxInputs"), hx::TCanCast< FlxInputs_obj> ,sStaticFields,sMemberFields,
