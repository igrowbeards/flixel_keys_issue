...
{
HX_STACK_PUSH("RectanglePointPair::new","org/flixel/system/layer/TileSheetData.hx",326);
{
	HX_STACK_LINE(327)
	this->rect = rect;
	HX_STACK_LINE(328)
...
{
		HX_STACK_PUSH("RectanglePointPair::destroy","org/flixel/system/layer/TileSheetData.hx",332);
		HX_STACK_THIS(this);
		HX_STACK_LINE(333)
		this->rect = null();
		HX_STACK_LINE(334)
