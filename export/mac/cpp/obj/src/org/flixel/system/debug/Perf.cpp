...
{
HX_STACK_PUSH("Perf::new","org/flixel/system/debug/Perf.hx",59);
...
{
		HX_STACK_PUSH("Perf::drawCalls","org/flixel/system/debug/Perf.hx",275);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Perf::visibleObjects","org/flixel/system/debug/Perf.hx",265);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Perf::activeObjects","org/flixel/system/debug/Perf.hx",256);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Count,"Count");
		HX_STACK_LINE(256)
...
{
		HX_STACK_PUSH("Perf::flash","org/flixel/system/debug/Perf.hx",247);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Perf::flixelDraw","org/flixel/system/debug/Perf.hx",238);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Time,"Time");
		HX_STACK_LINE(238)
...
{
		HX_STACK_PUSH("Perf::flixelUpdate","org/flixel/system/debug/Perf.hx",229);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Time,"Time");
		HX_STACK_LINE(229)
...
{
		HX_STACK_PUSH("Perf::update","org/flixel/system/debug/Perf.hx",137);
		HX_STACK_THIS(this);
		HX_STACK_LINE(138)
...
{
		HX_STACK_PUSH("Perf::destroy","org/flixel/system/debug/Perf.hx",113);
		HX_STACK_THIS(this);
		HX_STACK_LINE(114)
		if (((this->_text != null()))){
			HX_STACK_LINE(115)
