...
Float FlxRect_obj::get_bottom( ){
	HX_STACK_PUSH("FlxRect::get_bottom","org/flixel/FlxRect.hx",79);
	HX_STACK_THIS(this);
	HX_STACK_LINE(79)
...
Float FlxRect_obj::get_top( ){
	HX_STACK_PUSH("FlxRect::get_top","org/flixel/FlxRect.hx",69);
	HX_STACK_THIS(this);
	HX_STACK_LINE(69)
	return this->y;
}
...
Float FlxRect_obj::get_right( ){
	HX_STACK_PUSH("FlxRect::get_right","org/flixel/FlxRect.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_LINE(59)
...
Float FlxRect_obj::get_left( ){
	HX_STACK_PUSH("FlxRect::get_left","org/flixel/FlxRect.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
	return this->x;
}
