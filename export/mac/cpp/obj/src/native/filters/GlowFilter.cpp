...
{
HX_STACK_PUSH("GlowFilter::new","native/filters/GlowFilter.hx",8);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.filters.GlowFilter"), hx::TCanCast< GlowFilter_obj> ,sStaticFields,sMemberFields,
