...
{
HX_STACK_PUSH("DropShadowFilter::new","native/filters/DropShadowFilter.hx",21);
...
::native::filters::BitmapFilter DropShadowFilter_obj::clone( ){
	HX_STACK_PUSH("DropShadowFilter::clone","native/filters/DropShadowFilter.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_LINE(40)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.filters.DropShadowFilter"), hx::TCanCast< DropShadowFilter_obj> ,sStaticFields,sMemberFields,
